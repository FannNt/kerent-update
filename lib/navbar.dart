...
import 'package:kerent/app/modules/addProduct/views/add_product_view.dart';
import 'package:kerent/app/modules/chat/views/chat_list_view.dart';
        ...
        children: <Widget>[
          ...
          Transform(
            ...
            child: ElevatedButton(
              ...
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => AddProductView())),
              child: Container(
                width: 58.58,
                height: 58.58,
          ...
          _buildNavButton(
            ...
            'Chat',
            1,
            () => _navigateTo(context, ChatListView()),
          ),
        ],
      ),
    );
